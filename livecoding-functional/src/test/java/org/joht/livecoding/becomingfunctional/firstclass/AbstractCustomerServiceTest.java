...
import static org.joht.livecoding.becomingfunctional.firstclass.CustomerTestdata.JOHN_DOE;
import static org.joht.livecoding.becomingfunctional.firstclass.CustomerTestdata.RICHARD_MILES;
...
public abstract class AbstractCustomerServiceTest {
	...
	protected Collection<Kunde> getTestkunden() {
		return CustomerTestdata.of(JOHN_DOE, RICHARD_MILES);
	}
