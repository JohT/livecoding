...
public class D_Customers_GenericFunctionObjects implements KundenService {

	private final Collection<Kunde> kunden = new ArrayList<>();

	public D_Customers_GenericFunctionObjects(Collection<? extends Kunde> kunden) {
	...
	public String toString() {
		return "D_Customers_GenericFunctionObjects [kunden=" + kunden + "]";
	}
}