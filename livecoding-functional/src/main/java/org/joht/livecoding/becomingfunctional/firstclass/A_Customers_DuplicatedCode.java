...
public class A_Customers_DuplicatedCode implements KundenService {

	private final Collection<Kunde> kunden = new ArrayList<>();

	public A_Customers_DuplicatedCode(Collection<? extends Kunde> kunden) {
	...
	public String toString() {
		return "A_Customers_DuplicatedCode [kunden=" + kunden + "]";
	}
}