 ...
 * @author JohT
 */
public class E_Customers_DuplicatedLamndaRegression implements KundenService {

	private final Collection<Kunde> kunden = new ArrayList<>();

	public E_Customers_DuplicatedLamndaRegression(Collection<? extends Kunde> kunden) {
	...
	public String toString() {
		return "E_Customers_DuplicatedLamndaRegression [kunden=" + kunden + "]";
	}
}