...
public class C_Customers_FunctionObject implements KundenService {

	private final Collection<Kunde> kunden = new ArrayList<>();

	public C_Customers_FunctionObject(Collection<? extends Kunde> kunden) {
	...
	public String toString() {
		return "C_Customers_FunctionObject [kunden=" + kunden + "]";
	}
}