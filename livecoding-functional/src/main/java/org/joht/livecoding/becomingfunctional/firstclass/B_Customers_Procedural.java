...
public class B_Customers_Procedural implements KundenService {

	private final Collection<Kunde> kunden = new ArrayList<>();

	public B_Customers_Procedural(Collection<? extends Kunde> kunden) {
	...
	public String toString() {
		return "B_Customers_Procedural [kunden=" + kunden + "]";
	}
}